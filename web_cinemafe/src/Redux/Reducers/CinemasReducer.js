...
export const CinemasReducer = (state = stateDefault, action) => {
    switch (action.type) {
        ...
        case SET_LIST_THEATER_ROOM: {
            return { ...state, listRoomofTheater: action.listRoomofTheater };
        }

        case SET_LIST_INVOICE: {
            return { ...state, listInvoice: action.listInvoice };
        }
