                    ...
                    <div className="checkout-success-wr">
                        {
                            resultCode ? (
                                ...
                                (
                                    <>
                                        <h2 className="heading">Giao dịch thất bại</h2>
                                        <div className="grid justify-content-center my-[4rem]">
                                            <p className="d-flex justify-content-center">
                                                Giao dịch không thành công, vui lòng kiểm tra lại thông tin thanh toán của
                                                bạn
                                            </p>
                                            <p className="d-flex justify-content-center mt-2">Xin chân thành cảm ơn!</p>
                                        </div>
                                    </>
                                )
                        }
