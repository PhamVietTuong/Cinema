...
SET @NEW_GUID = NEWID();
INSERT SeatType(Id, Name, Status) VALUES (@NEW_GUID, N'Đơn',
1)
SET @NEW_GUID = NEWID();
INSERT SeatType(Id, Name, Status) VALUES (@NEW_GUID, N'Ðôi',
1)

SET @NEW_GUID = NEWID();
INSERT Theater(Id, Name, Address, Image, Phone, Status) VALUES (@NEW_GUID, N'CKC Quận 1', N'65 Huỳnh Thúc Kháng, Phường Bến Nghé ,Quận 1,Thành Phố Hồ Chí Minh',
1)
SET @NEW_GUID = NEWID();
INSERT Theater(Id, Name, Address, Image, Phone, Status) VALUES (@NEW_GUID, N'CKC Quận 3', N'Lầu 6 - 7,
19 Cao Thắng, P.2, Q.3, Tp. Hồ Chí Minh',
1)
SET @NEW_GUID = NEWID();
INSERT Theater(Id, Name, Address, Image, Phone, Status) VALUES (@NEW_GUID, N'CKC Quận 10', N'116 Nguyễn Tri Phương, Q.10, Tp. Hồ Chí Minh',
1)
SET @NEW_GUID = NEWID();
INSERT Theater(Id, Name, Address, Image, Phone, Status) VALUES (@NEW_GUID, N'CKC Quận 5', N'Tầng 7, Hùng Vương Plaza,
126 Hùng Vương, Q.5, Tp. Hồ Chí Minh',
1)
SET @NEW_GUID = NEWID();
INSERT Theater(Id, Name, Address, Image, Phone, Status) VALUES (@NEW_GUID, N'CKC Quận 7', N'Lầu 4, Siêu Thị Vincom 3/2,
3C Đường 3/2, Q.7, Tp. Hồ Chí Minh',
1)
...
INSERT ShowTime(Id, MovieId,
[Day
], StartTime, EndTime, Status) VALUES (@NEW_GUID, (select Id from Movie where Name=N'GODZILLA X KONG'), GETDATE() + 1, GETDATE(), GETDATE(),
1)
...
INSERT ShowTime(Id, MovieId,
[Day
], StartTime, EndTime, Status) VALUES (@NEW_GUID, (select Id from Movie where Name=N'KUNG FU PANDA 4'), GETDATE() + 3, GETDATE(), GETDATE(),
1)
INSERT ShowTimeRoom(Id, ShowTimeId, RoomId) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'))
...
INSERT ShowTime(Id, MovieId,
[Day
], StartTime, EndTime, Status) VALUES (@NEW_GUID, (select Id from Movie where Name=N'KUNG FU PANDA 4'), GETDATE() + 4, GETDATE(), GETDATE(),
1)
INSERT ShowTimeRoom(Id, ShowTimeId, RoomId) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'))

SET @NEW_GUID = NEWID();
INSERT TicketType(Id, SeatTypeId, Name, Price, Status) VALUES (@NEW_GUID, (select Id from SeatType where Name=N'Đơn'), N'HSSV-Người Cao Tuổi',
45000,
1)
SET @NEW_GUID = NEWID();
INSERT TicketType(Id, SeatTypeId, Name, Price, Status) VALUES (@NEW_GUID, (select Id from SeatType where Name=N'Ðôi'), N'Người lớn',
145000,
1)

SET @NEW_GUID = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID, NULL, (select Id from Room where Name='01'), 'A',
1, NULL,
0)
SET @NEW_GUID = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID, NULL, (select Id from Room where Name='01'), 'A',
...
SET @NEW_GUID = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID, NULL, (select Id from Room where Name='02'), 'A',
1, NULL,
0)
SET @NEW_GUID = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID, NULL, (select Id from Room where Name='02'), 'A',
...
SET @NEW_GUID = NEWID();
INSERT TicketType(Id, SeatTypeId, Name, Price, Status) VALUES (@NEW_GUID, (select Id from SeatType where Name=N'Đơn'), N'Người lớn',
70000,
1)

SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='01'), 'A',
3, 'A1',
0)
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='01'), 'A',
...
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'), 'A',
3, 'A2',
0)
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'), 'A',
...
SET @NEW_GUID = NEWID();
INSERT TicketType(Id, SeatTypeId, Name, Price, Status) VALUES (@NEW_GUID, (select Id from SeatType where Name=N'Ðôi'), N'HSSV-Người Cao Tuổi',
90000,
1)

SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='01'), 'B',
1, 'B1',
0)
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='01'), 'B',
...
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'), 'B',
1, 'B1',
0)
SET @NEW_GUID1 = NEWID();
INSERT Seat(Id, TicketTypeId, RoomId, RowName, ColIndex, Name, IsSeat) VALUES (@NEW_GUID1, @NEW_GUID, (select Id from Room where Name='02'), 'B',
...
SET @NEW_GUID = NEWID();
SET @NEW_GUID1 = NEWID();
INSERT MovieType(Id, Name, Status) VALUES (@NEW_GUID, N'Hành động',
1)
...
SET @NEW_GUID = NEWID();
SET @NEW_GUID1 = NEWID();
INSERT MovieType(Id, Name, Status) VALUES (@NEW_GUID, N'Hoạt hình',
1)
...
SET @NEW_GUID = NEWID();
SET @NEW_GUID1 = NEWID();
INSERT MovieType(Id, Name, Status) VALUES (@NEW_GUID, N'Hài hước',
1)
INSERT MovieTypeDetail(Id, MovieId, MovieTypeId) VALUES (@NEW_GUID1, (select Id from Movie where	Name=N'KUNG FU PANDA 4'), @NEW_GUID)

SET @NEW_GUID = NEWID();
INSERT FoodAndDrink(Id, Name, Image, Price, Description, Status) VALUES (@NEW_GUID, N'Combo Solo 2 Ngăn - VOL', 'BAP-2-NGAN_COMBO-SOLO.png',
119000, N'1 Coke 32oz - V + 1 Bắp 2 Ngăn 64OZ PM + CARAMEN',
1)
SET @NEW_GUID = NEWID();
INSERT FoodAndDrink(Id, Name, Image, Price, Description, Status) VALUES (@NEW_GUID, N'Combo Party 2 Ngăn - VOL', 'BAP-2-NGAN_COMBO-PARTY.png',
259000, N'4 Coke 22oz - V + 2 Bắp 2 Ngăn 64OZ PM + CARAMEN',
1)
SET @NEW_GUID = NEWID();
INSERT FoodAndDrink(Id, Name, Image, Price, Description, Status) VALUES (@NEW_GUID, N'Combo Couple 2 Ngăn - VOL', 'BAP-2-NGAN_COMBO-COUPLE.png',
129000, N'2 Coke 32oz - V + 1 Bắp 2 Ngăn 64OZ PM + CARAMEN',
1)
