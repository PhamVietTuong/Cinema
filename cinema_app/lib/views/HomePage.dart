  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Hi, Nhu Y!", style: TextStyle(fontSize: 20, color: Colors.white)),
    ...
    children: [
      Container(
        ...
        height: MediaQuery.of(context).size.height * 2 / 6,//chiếm 2 phần trên màn hình
        decoration: BoxDecoration(
...
class MySecondCarousel extends StatefulWidget {
  @override
  _MySecondCarouselState createState() => _MySecondCarouselState();
}
