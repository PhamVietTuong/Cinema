  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ? Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        ...
                        fit: BoxFit
                            .cover, // Tuỳ chỉnh cách hình ảnh được hiển thị
                      ),
                    ),
                  )
        ...
        const Text(
            "Diễn viên: William Atherton, Emily Alyn Lind, James Acaster, Annie Potts, Ernie Hudson",
            style: TextStyle(fontSize: 18)),
        const Text(
            "Mô tả phim: Sau các sự kiện của Ghostbusters: Afterlife, gia đình Spengler đang tìm kiếm cuộc sống mới ở..Xem thêm ",
            style: TextStyle(fontSize: 18)),
        Container(
