...
export const selectNowShowingTotal = createSelector(selectMoviesState, s => s.nowShowingTotal);
export const selectComingSoon = createSelector(selectMoviesState, s => s.comingSoon);
export const selectComingSoonTotal = createSelector(selectMoviesState, s => s.comingSoonTotal);
